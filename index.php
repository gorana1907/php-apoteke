...
<div class="forma" style="margin-top: 50px;border-radius:25px">
    <form method="post">
        ...
        <div class="d-grid gap-2 d-md-block">
            <button type="submit" id="login" class="btn btn-success" style="background-color: rgb(11, 218, 81); border: none">Prijavi se</button>
            <button type="button" id="register" onclick="document.location.href='registracija.php'" class="btn btn-primary" style="background-color: rgb(79, 121, 66); border: none">Registruj se</button>
        </div>
